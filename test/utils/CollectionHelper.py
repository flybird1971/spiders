		...
		if maxDeepth!=0 and isinstance(li,list):
			...
			for tmpCollection in li:
				if(isinstance(tmpCollection,(list,tuple,dict))):
					...
					CollectionHelper.printEx(tmpCollection,maxDeepth-1,currentDeepth+1)
				else:
					CollectionHelper.formatPrint( CollectionHelper.prefix*currentDeepth,"list index ",index,":",tmpCollection)
				index += 1
		else:
			CollectionHelper.formatPrint( CollectionHelper.prefix*currentDeepth,li)
		pass
		...
		if maxDeepth!=0 and isinstance(tp,tuple):
			...
			for tmpCollection in tp:
				if(isinstance(tmpCollection,(list,tuple,dict))):
					...
					CollectionHelper.formatPrint( CollectionHelper.prefix*currentDeepth,"tuple index ",index,":",tmpCollection)
				index += 1
		else:
			CollectionHelper.formatPrint(CollectionHelper.prefix*currentDeepth,tp)
		pass
		...
		if maxDeepth!=0 and isinstance(diction,dict):
			for tmpCollection in diction:
				if(isinstance(diction[tmpCollection],(list,tuple,dict))) and diction[tmpCollection]:
					CollectionHelper.formatPrint( CollectionHelper.prefix*currentDeepth,tmpCollection,":")
					CollectionHelper.printEx(diction[tmpCollection],maxDeepth-1,currentDeepth+1)
				else:
					CollectionHelper.formatPrint( CollectionHelper.prefix*currentDeepth,tmpCollection,":",diction[tmpCollection])
		else:
			CollectionHelper.formatPrint(CollectionHelper.prefix*currentDeepth,diction)
		pass
